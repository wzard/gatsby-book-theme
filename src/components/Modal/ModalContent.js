...
export default ({ children, isOpen, closeModal, isClosing, sourceRef, background, className, textColor }) => {
	let translateX = 0;
	let translateY = 0;
	let scaleX = 0;
	let scaleY = 0;
	...
	return (
		<DialogContent
			style={{
				...
				position: 'absolute',
				top: 0,
				transform: `translate3D(${content.translateX}, ${content.translateY}, 0) scale(${content.scaleX}, ${content.scaleY})`,
